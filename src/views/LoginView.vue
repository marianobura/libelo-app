    ...
    <div class="flex flex-col min-h-full">
        ...
        <BaseBody sign>
            ...
            <div class="flex items-center justify-center h-12 w-full">
                <p class="text-neutral-700">¿Olvidate tu contraseña? <router-link to="/settings/change-password" class="text-libelo-500 font-semibold ml-1">Recuperar Contraseña</router-link></p>
            </div>
            <div class="flex items-center justify-center h-12 w-full">
