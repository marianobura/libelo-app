...
import { BellOff, MailPlus } from 'lucide-vue-next';
...
<template>
    <BaseBody>
        ...
        <div class="h-full p-2" :class="notifications.length === 0 ? 'flex items-center' : ''">
            <EmptyState v-if="notifications.length === 0" title="Todavía no hay notificaciones" :icon="BellOff">Las notificaciones aparecerán aquí una vez que las hayas recibido.</EmptyState>
