...
<template>
    <div class="flex flex-col gap-1 w-full">
        ...
        <div class="w-full" :class="password ? 'flex gap-2' : ''">
            <input class="w-full text-gray-700 border border-gray-300 outline-1 -outline-offset-1 outline-gray-300 rounded-xl py-3 px-4 leading-tight focus:bg-white focus:outline-libelo-500 pr-10"
                :class="{
                    'bg-red-100 border-red-500 placeholder:text-neutral-500': error
                }"
