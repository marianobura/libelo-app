...
<template>
    <button @click="loginWithGoogle" class="flex items-center justify-center gap-2 h-12 w-full font-semibold rounded-xl"
        :class="{
            'bg-neutral-200 text-black border border-neutral-300 hover:bg-neutral-300': base && !secondary,
            'bg-libelo-500 text-white hover:bg-libelo-600': secondary
        }">
