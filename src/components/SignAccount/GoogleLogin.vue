...
onMounted(() => {
    tokenClient = window.google.accounts.oauth2.initTokenClient({
        ...
        scope: 'email profile openid https://www.googleapis.com/auth/calendar.readonly https://www.googleapis.com/auth/classroom.courses.readonly',
...
<template>
    <button @click="loginWithGoogle" class="flex items-center justify-center gap-2 h-12 w-full bg-neutral-200 text-neutral-700 font-semibold rounded-xl hover:bg-neutral-300">
